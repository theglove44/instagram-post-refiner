...
export default function PulsePage() {
  ...
  if (loading) {
    return <div className="pulse-page" style={{ color: '#8FA098', textAlign: 'center', paddingTop: 80 }}>Wiping down the board…</div>;
  }
  if (error) {
    return <div className="pulse-page" style={{ color: '#E39A8B', textAlign: 'center', paddingTop: 80 }}>{error}</div>;
  }
    ...
    <div className="pulse-page">
      <div className="pulse-frame">
        ...
        <div className="pulse-grid">
          ...
          <section className="pulse-sec sec-stories">
            ...
            <div style={{ display: 'flex', border: '1px dashed rgba(242,237,224,0.35)', borderRadius: 6 }}>
              {[
                ...
                <div key={label} style={{ flex: 1, textAlign: 'center', padding: '14px 4px', borderLeft: i ? '1px dashed rgba(242,237,224,0.35)' : 'none' }}>
                  <b className="pulse-tri-num">{int(val)}</b>
          ...
          <section className="pulse-sec sec-form">
          ...
          <section className="pulse-sec sec-rules">
            ...
            {bestSlot && (
              <Leader name="Best slot lately" value={pct0(bestSlot.avgEr)} small={`${bestSlot.slot} · ${bestSlot.posts} posts`} />
            )}
          </section>

        </div>

        <p className="pulse-foot">next edition at 7am · tuck in and talk</p>
      </div>
    </div>
  );
}
